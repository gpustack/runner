...
|------------------------------|-----------|--------------------------------------------------------------------------------------|------------------------|
| 9.0 (A3/910C)                |           | **`0.20.2`**(rc)                                                                             | `0.5.15.post1`               |
| 9.0 (910B)                   |           | **`0.20.2`**(rc)                                                                             | `0.5.15.post1`               |
| 9.0 (310P)                   |           | **`0.20.2`**(rc)                                                                             |                        |
...
|------------------------------|------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|----------|
| 13.0                         | **`0.27.1`**, `0.25.1`, `0.24.0`, `0.22.1`, <br/>`0.21.0`, `0.20.2`, <br/>`0.19.1`, `0.18.1`                                                                            | `0.5.15.post1`, `0.5.14`, <br/>`0.5.12.post1`                                                |          |
| 12.9                         | **`0.27.1`**, `0.25.1`, `0.24.0`, `0.22.1`, <br/>`0.21.0`, `0.20.2`, <br/>`0.19.1`, `0.18.1`, <br/>`0.17.1`, `0.16.0`, <br/>`0.15.1`, `0.14.1`, <br/>`0.13.0`, `0.12.0`, <br/>`0.11.2` | `0.5.15.post1`, `0.5.14`, `0.5.12.post1`, <br/>`0.5.9`, `0.5.8.post1`, <br/>`0.5.7`, `0.5.6.post2` |          |
...
|------------------------------|-------------------------------------------------------------------------------------|-----------------------------------------------------------|
| 7.2                          | **`0.27.1`**, `0.25.1`, `0.24.0`, `0.22.1`, <br/>`0.21.0`, `0.20.2`, <br/>`0.19.1`                                                   | `0.5.15.post1`, `0.5.14`, <br/>`0.5.12.post1`                                 |
| 7.1                          | `0.17.1`                                                                            |                                                           |
