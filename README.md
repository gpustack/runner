...
| 8.3 (910B)                   | **`2.2.rc1`**            | **`0.11.0`**                                                         | `0.5.6.post2`          |
| 8.3 (310P)                   | **`2.2.rc1`**            |                                                                      |                        |
...
|------------------------------|--------------------------------------------------------------|-----------------------------------------------------------|----------|
| 12.9                         | `0.11.2`                                                     | `0.5.6.post2`                                             |          |
| 12.8                         | `0.11.2`, `0.11.0`, <br/>`0.10.2`, `0.10.1.1`, <br/>`0.10.0` | `0.5.6.post2`, `0.5.5.post3`, <br/>`0.5.5`, `0.5.4.post3` | `0.0.20` |
| 12.6                         | `0.11.2`, `0.11.0`, <br/>`0.10.2`, `0.10.1.1`, <br/>`0.10.0` | `0.5.6.post2`                                             | `0.0.20` |
